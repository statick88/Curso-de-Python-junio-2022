...
Tambien es posible actualizar los registros mediante la instrucción update
...
En Workbench no sucede ese cambio por una especie de seguridad que incluye workbench para evitar hacer ese tipo de cosas, sin embargo en producción no esta workbench y ahí si va a funcionar este comando, así que lo mejor es asegurarse de que un where siempre le sigue a un update.
